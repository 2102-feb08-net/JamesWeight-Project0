...
namespace Application
{
    ...
    {   
        // Main Routine to call Methods from other Classes in
        // The Namespace Nomenclature.
        // 'Polymorph': InterfaceRoutines InstantiateViewUnitTesting = new InterfaceRoutines();
        ...
        static bool StructuralIntegrityUTintegration(){
           ...
           SDroutines _instantiateViewUT4 = new SDroutines(); _instantiateViewUT4.Display();
           HUMroutines _instantiateViewUT5 = new HUMroutines(); _instantiateViewUT5.Display();
